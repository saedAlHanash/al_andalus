...
class DrivingLicenseFieldsWidget extends StatefulWidget {
  const DrivingLicenseFieldsWidget({super.key});

  @override
  State<DrivingLicenseFieldsWidget> createState() => _DrivingLicenseFieldsWidgetState();
}

class _DrivingLicenseFieldsWidgetState extends State<DrivingLicenseFieldsWidget> {
          ...
          child: Column(
            ...
            children: [
              ...
              MyTextFormOutLineWidget(
                onChanged: (p0) {
                  state.mRequest.licenseNumber = p0;
                },
